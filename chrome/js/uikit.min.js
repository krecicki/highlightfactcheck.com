/*! UIkit 3.21.10 | https://www.getuikit.com | (c) 2014 - 2024 YOOtheme | MIT License */ (function (
  be,
  xe
) {
  ...
  function ka(t) {
    t._hasComputed &&
      ...
      t._disconnect.push(() => {
        t._computedObserver.disconnect(), Un(t);
      }));
  }
  function Un(t) {
    const e = { ...t._computed };
  ...
  (lt.util = Lr), (lt.options = {}), (lt.version = '3.21.10');
  const Ba = 'uk-',
    Vt = '__uikit__',
    pe = {};
  function Xn(t, e) {
    ...
    observe: [
      ue({
        ...
        handler([{ isIntersecting: t }]) {
          document.fullscreenElement || (t ? ls(this.$el) : wi(this.$el));
        },
        args: { intersecting: !1 },
          ...
          read({ height: t, width: e, margin: i, sticky: s }, n) {
            ...
            const f = this.overflowFlip ? 0 : Math.max(0, t + d - r),
              ...
              P =
                this.end === !1
                  ? l
                  : Math.min(l, zs(this.end, this.$el, p + t, !0) - b - d + f);
            return (
              (s =
                l &&
                !this.showOnUp &&
                I + d === p &&
                P === Math.min(l, zs(!0, this.$el, 0, !0) - b - d + f) &&
